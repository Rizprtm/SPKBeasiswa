...
class HomeController extends Controller
{
    ...
    public function periode()
    {
        ...
        return view('periode', compact('dataperiode','mahasiswa','userId'));
    }
    public function store_periode(Request $request, $periode_id)
    {
        ...
        public function periode_edit($id)
    {
        ...
        return view('edit_periode', compact('dataperiode','mahasiswa','userId'));
    }
